...
public class Bol2ComApi {
    ...
    private ResponseEntity<AccesToken> refreshJwtToken() throws ApiException {
        ...
        final String DATA = "client_id=3e958677-38ce-4e5d-a1cf-308f65fa386f&"
                + "client_secret=MzVAkzoO9-iwOphruPWttLRrv2uVD7hKbogn-BQ2S_EGrI4BwcJspuZnqLNPp9TLZ_GePvKKzxCtVesITszvlg&"
